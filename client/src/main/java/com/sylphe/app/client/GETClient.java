...
public class GETClient {
	...
	public static void main(String args[]) {
		...
		//	client.put(data.getByteStream(),com.sylphe.app.dto.MsgType.SEND_LOCATION);
...
/*
			CoapClient client = new CoapClient(uri);
			client.put("client post message!",111);
...
*/
			...
			// display help
			System.out.println("Californium (Cf) GET com.sylphe.app.dto.Client");
