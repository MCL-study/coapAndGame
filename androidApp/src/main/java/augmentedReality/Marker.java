...
public class Marker implements Comparable<Marker> {
    ...
    public Marker(String name, double latitude, double longitude, double altitude, int color, Map markerMap) {
		set(name, latitude, longitude, altitude, color, markerMap);
	}

	public synchronized void set(String name, double latitude, double longitude, double altitude, int color, Map markerMap) {
    ...
    public synchronized PhysicalLocationUtility getLocation2() {
