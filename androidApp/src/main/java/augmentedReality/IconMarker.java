...
public class IconMarker extends Marker {
    ...
    public IconMarker(String name, double latitude, double longitude, double altitude, int color, Bitmap bitmap, Map markerMap) {
        super(name, latitude, longitude, altitude, color, markerMap);
        this.bitmap = bitmap;
    }
